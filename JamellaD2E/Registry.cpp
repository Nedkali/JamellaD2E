...
QueryValues[] =
{
 { "CreateItemRecordFormat", REG_DWORD, (BYTE*)&RegOptions.CreateItemRecordFormat, sizeof RegOptions.CreateItemRecordFormat, 0 },
 { "AllItemsSocketable", REG_DWORD, (BYTE*)&RegOptions.AllItemsSocketable, sizeof RegOptions.AllItemsSocketable, 0 },
 { "7Gems", REG_DWORD, (BYTE*)&RegOptions.A7Gems, sizeof RegOptions.A7Gems, 0 },
 { "ExceedQuantity", REG_DWORD, (BYTE*)&RegOptions.ExceedQuantity, sizeof RegOptions.ExceedQuantity, 0 },
 { "ItemPath", REG_SZ, (BYTE*)RegOptions.ItemPath, sizeof RegOptions.ItemPath, 0 },
 { "Associations", REG_DWORD, (BYTE*)&RegOptions.Associations, sizeof RegOptions.Associations, 1 },
 { "ToolTips", REG_DWORD, (BYTE*)&RegOptions.ToolTips, sizeof RegOptions.ToolTips, 1 },
 { "AnnoyingMsgs", REG_DWORD, (BYTE*)&RegOptions.NoAnnoyingMsgs, sizeof RegOptions.NoAnnoyingMsgs, 0 },
};
