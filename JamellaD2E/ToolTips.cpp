...
HWND CreateToolTipCtrl(HWND hParent, int ToolSet, bool Relay)
{
	...
	HWND hTip = CreateWindowEx(NULL, TOOLTIPS_CLASS, NULL, WS_POPUP | TTS_NOPREFIX | TTS_ALWAYSTIP | TTS_BALLOON, CW_USEDEFAULT, CW_USEDEFAULT,	CW_USEDEFAULT, CW_USEDEFAULT, hParent, NULL, hInstance, NULL);
